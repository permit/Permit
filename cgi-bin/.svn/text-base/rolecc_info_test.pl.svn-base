...
#
 ...
 $url_stem7 = "https://$host/cgi-bin/qualauth.pl?";
...
#
 ...
 $who_auth_trav_url = 
        ...
        . '</A>';
 $who_payr_by_pccs = 
        '<A HREF="' . $url_stem7 . "category=PAYR&qualtype=PCCS"
        . "&detail=2&childqc="
        . $qcode . '">' 
        . "Part 1 - by PCCS hierarchy" 
        . '</A>';
 $who_payr_by_pmit = 
        '<A HREF="' . $url_stem7 . "category=PAYR&qualtype=PMIT"
        . "&detail=2&childqc="
        . $pc_code . '">' 
        . "Part 2 - by PMIT hierarchy" 
        . '</A>';
...
#
 ...
 print "Who can: &nbsp;&nbsp;&nbsp; $who_auth_req_url &nbsp;&nbsp;&nbsp;"
        ...
        . " all funds/cost objects)<br>";
 print "Who can perform Payroll-related functions?* &nbsp;&nbsp;&nbsp; $who_auth_req_url &nbsp;&nbsp;&nbsp;"
        . "$who_payr_by_pccs &nbsp;&nbsp;&nbsp;"
        . "$who_payr_by_pmit &nbsp;&nbsp;&nbsp;";
...
sub get_has_child_id {
  ...
  do $csr->finish() || &web_error("Oracle error. can't close cursor");
