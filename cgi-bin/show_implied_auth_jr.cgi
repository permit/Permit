...
#
 ...
 $g_max_rows = $formval{'max_rows'};
 $g_kerbname_first_letter = $formval{'kerbname_first_letter'};
...
#
 ...
 $g_max_max_rows = 2000;
 $g_default_max_rows = 100;
 $g_any_letter_string = 'any';
...
#
 ...
 if ($g_lookup_number eq '0') {
   ...
   my $max_rows = ($g_max_rows) ? $g_max_rows : $g_default_max_rows;
   if ($max_rows > $g_max_max_rows) {$max_rows = $g_max_max_rows;}
   &report_1($lda, $g_ruleid, $max_rows, $g_kerbname_first_letter);
 }
...
###########################################################################
sub report_1 {
  my ($lda, $rule_id, $max_rows, $kerbname_first_letter) = @_;
 ...
 #
 #  Define a SQL fragment for limiting results by usernames with a given
 #  initial letter 
 #
  my $sql_frag = "";
  if ($kerbname_first_letter ne '' 
      && $kerbname_first_letter ne $g_any_letter_string) {
    $sql_frag = " and a.kerberos_name like '${kerbname_first_letter}%'";
  }
 ...
 #
  ...
  print "</table>\n";
  print "<p />Number of authorizations shown = $count<BR>\n";
...
sub report_0 {
 ...
 #
  print "Show results of an implied authorization rule<p />\n";
  ...
  print "</select></td></tr>\n";
  print "<tr><td>Maximum returned rows</td>";
  print "<td><select name=\"max_rows\">\n";
  print "<option>10</option>\n";
  print "<option>50</option>\n";
  print "<option selected>100</option>\n";
  print "<option>200</option>\n";
  print "<option>500</option>\n";
  print "<option>1000</option>\n";
  print "<option>2000</option>\n";
  print "</select></td></tr>\n";
  print "<tr><td>Username starts with</td>";
  print "<td><select name=\"kerbname_first_letter\">\n";
  print "<option>any</option>\n";
  my $letters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
  my $n = 26;
  for ($i = 0; $i < $n; $i++) {
     print "<option>" . substr($letters, $i, 1) . "\n";
  }
  print "</select></td></tr>\n";
  print "</table>\n";
