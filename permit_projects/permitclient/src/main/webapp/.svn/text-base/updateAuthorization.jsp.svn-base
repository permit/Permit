...
<html>
    <head>
        ...
        <title>Permitws Update Authorization</title>
    </head>
    <body>

    <h1>Permitws Web Service updateAuthorization Test Page</h1>
    ...
    <form action="updateAuthorizationResponse.jsp" method="POST">
      <table>
