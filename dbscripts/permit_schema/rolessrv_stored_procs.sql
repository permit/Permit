...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_append`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_append`(
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_append`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_append`(
    p_base_array_name     varchar(50),
    p_second_array_name varchar(50)
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_clear`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_clear`(
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_clear`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_clear`(
    p_array_name varchar(50)
) RETURNS int(11)
    MODIFIES SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_copy`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_copy`(
    p_array_name     varchar(50),
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_copy`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_copy`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50)
) RETURNS varchar(50) CHARSET latin1
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_copy_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_copy_complete`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50),
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_copy_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_copy_complete`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50),
    on_key_conflict  enum("use_first", "use_second"),
    drop_new         boolean,
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_create`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_create`(
    p_array_name varchar(50),
    p_array_size int
)
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_create`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_create`(
    p_array_name varchar(50),
    p_array_size int
) RETURNS int(11)
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_drop`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_drop`(
    p_array_name varchar(50)
)
    MODIFIES SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_drop`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_drop`(
    p_array_name varchar(50)
) RETURNS int(11)
    MODIFIES SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_exists`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_exists`( p_array_name varchar(50) ) RETURNS tinyint(1)
    READS SQL DATA
begin
    return 
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_from_list`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_from_list`(
    p_list        text,
    p_array_name  varchar(50)
)
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_from_list`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_from_list`(
    p_list        text,
    p_array_name  varchar(50)
) RETURNS varchar(50) CHARSET latin1
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_from_list_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_from_list_complete`(
    p_list        text,
    p_array_name  varchar(50),
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_from_list_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_from_list_complete`(
    p_list        text,
    p_array_name  varchar(50),
    p_separator   varchar(10)
) RETURNS varchar(50) CHARSET latin1
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_from_pair_list`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_from_pair_list`(
    p_list             text,
    p_array_name       varchar(50)
)
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_from_pair_list`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_from_pair_list`(
    p_list             text,
    p_array_name       varchar(50)
) RETURNS varchar(50) CHARSET latin1
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_from_pair_list_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_from_pair_list_complete`(
    p_list             text,
    p_array_name       varchar(50),
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_from_pair_list_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_from_pair_list_complete`(
    p_list             text,
    p_array_name       varchar(50),
    p_list_separator   varchar(10),
    p_pair_separator   varchar(10)
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_full_list`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_full_list`()
    READS SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_get`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_get`(
    p_array_name    varchar(50),
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_get_key_by_index`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_get_key_by_index`(
    p_array_name    varchar(50),
    p_array_index   int
) RETURNS text CHARSET latin1
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_get_or_create_id`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_get_or_create_id`(
    p_array_name varchar(50)
) RETURNS int(11)
    MODIFIES SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_get_value_by_index`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_get_value_by_index`(
    p_array_name    varchar(50),
    p_array_index   int
) RETURNS text CHARSET latin1
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_get_value_by_key`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_get_value_by_key`(
    p_array_name    varchar(50),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_grep`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_grep`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50),
    value_regexp       varchar(100)
)
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_grep`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_grep`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50),
    value_regexp     varchar(100)
) RETURNS varchar(50) CHARSET latin1
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_grep_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_grep_complete`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50),
    key_regexp       varchar(100),
    value_regexp     varchar(100)
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_grep_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_grep_complete`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50),
    key_regexp       varchar(100),
    value_regexp     varchar(100)
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_list`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_list`()
    READS SQL DATA
begin
    select array_id, array_name, array_size
        from 
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_max_index`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_max_index`( p_array_name varchar(50) ) RETURNS int(11)
    READS SQL DATA
begin
    declare asize int;
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_merge`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_merge`(
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_merge`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_merge`(
    p_first_array_name     varchar(50),
    p_second_array_name    varchar(50),
    p_new_array_name       varchar(50)
) RETURNS varchar(50) CHARSET latin1
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_merge_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_merge_complete`(
    p_first_array_name     varchar(50),
    p_second_array_name    varchar(50),
    p_new_array_name       varchar(50),
    on_key_conflict        enum("use_first", "use_second")
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_merge_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_merge_complete`(
    p_first_array_name     varchar(50),
    p_second_array_name    varchar(50),
    p_new_array_name       varchar(50),
    on_key_conflict        enum("use_first", "use_second")
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_pop`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_pop`(
    p_array_name    varchar(50)
) RETURNS text CHARSET latin1
    MODIFIES SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_push`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_push`(
    p_array_name    varchar(50),
    p_array_value   text
)
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_push`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_push`(
    p_array_name    varchar(50),
    p_array_value   text
) RETURNS int(11)
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_set`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_set`(
    p_array_name  varchar(50),
    p_array_ndx_key varchar(50),
    p_array_value text
)
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_set`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_set`(
    p_array_name  varchar(50),
    p_array_ndx_key varchar(50),
    p_array_value text
) RETURNS int(11)
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_set_key_by_index`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_set_key_by_index`(
    p_array_name  varchar(50),
    p_array_index int,
    p_array_key   varchar(50)
)
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_set_key_by_index`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_set_key_by_index`(
    p_array_name  varchar(50),
    p_array_index int,
    p_array_key   varchar(50)
) RETURNS int(11)
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_set_value_by_index`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_set_value_by_index`(
    p_array_name  varchar(50),
    p_array_index int,
    p_array_value text
)
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_set_value_by_index`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_set_value_by_index`(
    p_array_name  varchar(50),
    p_array_index int,
    p_array_value text
) RETURNS int(11)
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_set_value_by_key`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_set_value_by_key`(
    p_array_name  varchar(50),
    p_array_key   varchar(50),
    p_array_value text
)
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_set_value_by_key`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_set_value_by_key`(
    p_array_name  varchar(50),
    p_array_key   varchar(50),
    p_array_value text
) RETURNS int(11)
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_setn`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_setn`(
    p_array_name  varchar(50),
    p_array_ndx_key varchar(50),
    p_array_value text
) RETURNS varchar(50) CHARSET latin1
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_shift`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_shift`(
    p_array_name    varchar(50)
) RETURNS text CHARSET latin1
    MODIFIES SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_show`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_show`(
    p_array_name varchar(50)
)
    READS SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_size`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_size`( p_array_name varchar(50) ) RETURNS int(11)
    READS SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_sort`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_sort`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50)
)
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_sort`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_sort`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50)
) RETURNS varchar(50) CHARSET latin1
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_sort_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_sort_complete`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50),
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_sort_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_sort_complete`(
    p_array_name     varchar(50),
    p_new_array_name varchar(50),
    order_by         enum("K","V","VN","VK"),
    order_direction  enum("asc", "desc")
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_temp_name`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_temp_name`() RETURNS varchar(50) CHARSET latin1
    READS SQL DATA
begin
    return concat('_sp', 
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_to_list`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_to_list`(
    p_array_name  varchar(50)
) RETURNS text CHARSET latin1
    READS SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_to_list_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_to_list_complete`(
    p_array_name  varchar(50),
    p_separator   varchar(10)
) RETURNS text CHARSET latin1
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_to_pair_list`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_to_pair_list`(
    p_array_name       varchar(50)
) RETURNS text CHARSET latin1
    READS SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_to_pair_list_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_to_pair_list_complete`(
    p_array_name       varchar(50),
    p_list_separator   varchar(10),
    p_pair_separator   varchar(10)
) RETURNS text CHARSET latin1
...
DROP PROCEDURE IF EXISTS `rolessrv`.`array_unshift`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`array_unshift`(
    p_array_name    varchar(50),
    p_array_value   text
)
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_unshift`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`array_unshift`(
    p_array_name    varchar(50),
    p_array_value   text
) RETURNS int(11)
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`array_user`$$
CREATE DEFINER=`rolesbb`@`%` FUNCTION  `rolessrv`.`array_user`() RETURNS varchar(50) CHARSET latin1
    READS SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`arrays_available`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`arrays_available`( ) RETURNS tinyint(1)
    READS SQL DATA
begin
    return 
...
DROP PROCEDURE IF EXISTS `rolessrv`.`check_for_routines_existence`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`check_for_routines_existence`(
...
DROP PROCEDURE IF EXISTS `rolessrv`.`check_routine`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`check_routine`(
    p_db_name       varchar(50),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`check_routine_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`check_routine_simple`(
    p_routine_name  varchar(50),
    p_routine_type  enum('procedure', 'function')
)
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`check_table`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`check_table`(
    p_db_name       varchar(50),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`check_view`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`check_view`(
    p_db_name       varchar(50),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_array_item`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_array_item`(
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_array_item_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_array_item_complete`(
    array_name   varchar(50),
    min_index    int,
    max_index    int,
    sql_command  text,
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_array_item_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_array_item_simple`(
    array_name   varchar(50),
    sql_command  text
)
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_counter`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_counter`( 
    counter_start   INT,
    counter_end     INT,
    counter_delta   INT,
    sql_command     text
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_counter_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_counter_complete`( 
    counter_start   INT,
    counter_end     INT,
    counter_delta   INT,
    sql_command     text,
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_list_item`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_list_item`(
    list_value   text,
    sql_command  text
)
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_list_item_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_list_item_complete`(
    list_value   text,
    sql_command  text,
    sql_before   text,
    sql_after    text,
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_table`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_table`( 
    db_name         varchar(50), 
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_table_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_table_complete`( 
    db_name         varchar(50), 
    condition_text  varchar(50),
    sql_command     text,
    sql_before      text,
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_table_value`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_table_value`(
    db_name          varchar(50),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_table_value_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_table_value_complete`(
    db_name          varchar(50),
    table_name       varchar(50),
    wanted_col1      varchar(50),
    wanted_col2      varchar(50),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_each_table_value_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_each_table_value_simple`(
    db_name          varchar(50),
    table_name       varchar(50),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_once`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_once`( sql_command text )
    MODIFIES SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`for_once_complete`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`for_once_complete`( 
    sql_command text,
    sql_before  text,
    sql_after   text )
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`fsyntax`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`fsyntax`(
...
DROP FUNCTION IF EXISTS `rolessrv`.`function_exists`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`function_exists`(
    p_db_name varchar(50), 
    p_function_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`function_exists_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`function_exists_simple`(
    p_function_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`get_auth_general_cursor`$$
CREATE DEFINER=`rolesbb`@`%` PROCEDURE  `rolessrv`.`get_auth_general_cursor`(IN ai_server_user  VARCHAR(20),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`get_auth_general_sql`$$
CREATE DEFINER=`rolesbb`@`%` PROCEDURE  `rolessrv`.`get_auth_general_sql`(IN ai_server_user  VARCHAR(20),
       IN ai_proxy_user  VARCHAR(20),
       IN ai_num_criteria  INTEGER, 
       IN ai_id1  VARCHAR(30), IN ai_value1  VARCHAR(255),
       IN ai_id2  VARCHAR(30), IN ai_value2  VARCHAR(255),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`get_auth_person_cursor`$$
CREATE DEFINER=`rolesbb`@`%` PROCEDURE  `rolessrv`.`get_auth_person_cursor`(in ai_server_user VARCHAR(20),
       in ai_proxy_user  VARCHAR(20),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`get_auth_person_cursor2`$$
CREATE DEFINER=`rolesbb`@`%` PROCEDURE  `rolessrv`.`get_auth_person_cursor2`(in ai_server_user VARCHAR(20),
       in ai_proxy_user  VARCHAR(20),
       in ai_kerberos_name  VARCHAR(20),
       in ai_function_category  VARCHAR(4),
       in ai_expand_qualifiers  VARCHAR(100),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`get_auth_person_sql`$$
CREATE DEFINER=`rolesbb`@`%` PROCEDURE  `rolessrv`.`get_auth_person_sql`(in ai_server_user VARCHAR(20),
       in ai_proxy_user  VARCHAR(20),
       in ai_kerberos_name  VARCHAR(20),
       in ai_function_category  VARCHAR(4),
       in ai_expand_qualifiers  VARCHAR(100),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`get_auth_person_sql_extend1`$$
CREATE DEFINER=`rolesbb`@`%` PROCEDURE  `rolessrv`.`get_auth_person_sql_extend1`(IN ai_server_user VARCHAR(20),
       IN ai_proxy_user VARCHAR(20),
       IN ai_kerberos_name VARCHAR(20),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`get_auth_person_sql_extend1_cursor`$$
CREATE DEFINER=`rolesbb`@`%` PROCEDURE  `rolessrv`.`get_auth_person_sql_extend1_cursor`(IN ai_server_user VARCHAR(20),
       IN ai_proxy_user VARCHAR(20),
       IN ai_kerberos_name VARCHAR(20),
       IN ai_function_category VARCHAR(20),
       IN ai_expand_qualifiers VARCHAR(20),
...
DROP PROCEDURE IF EXISTS `rolessrv`.`get_auth_person_sql2`$$
CREATE DEFINER=`rolesbb`@`%` PROCEDURE  `rolessrv`.`get_auth_person_sql2`(in ai_server_user VARCHAR(20),
       in ai_proxy_user  VARCHAR(20),
       in ai_kerberos_name  VARCHAR(20),
       in ai_function_category  VARCHAR(4),
       in ai_expand_qualifiers  VARCHAR(100),
...
DROP FUNCTION IF EXISTS `rolessrv`.`get_sql_fragment`$$
CREATE DEFINER=`rolesbb`@`%` FUNCTION  `rolessrv`.`get_sql_fragment`(ai_proxy_user VARCHAR(20),
     ni_id  integer,
...
DROP FUNCTION IF EXISTS `rolessrv`.`get_view_category_list`$$
CREATE DEFINER=`rolesbb`@`%` FUNCTION  `rolessrv`.`get_view_category_list`(ai_server_user VARCHAR(20),
...
DROP FUNCTION IF EXISTS `rolessrv`.`GetErrorMessage`$$
CREATE DEFINER=`rolesbb`@`%` FUNCTION  `rolessrv`.`GetErrorMessage`(message_id  INTEGER) RETURNS varchar(255) CHARSET latin1
BEGIN
...
DROP PROCEDURE IF EXISTS `rolessrv`.`global_var_drop`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`global_var_drop`(
...
DROP FUNCTION IF EXISTS `rolessrv`.`global_var_drop`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`global_var_drop`(
    p_var_name varchar(50)
) RETURNS tinyint(1)
    MODIFIES SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`global_var_exists`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`global_var_exists`(
    p_var_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
return coalesce(
...
DROP FUNCTION IF EXISTS `rolessrv`.`global_var_get`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`global_var_get`(
    p_var_name varchar(50)
) RETURNS text CHARSET latin1
    READS SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`global_var_set`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`global_var_set`(
    p_var_name varchar(50),
    p_value    text
)
    MODIFIES SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`global_var_set`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`global_var_set`(
    p_var_name varchar(50),
    p_value    text
) RETURNS text CHARSET latin1
    MODIFIES SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`initialize_tests`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`initialize_tests`()
    DETERMINISTIC
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`is_user_authorized`$$
CREATE DEFINER=`rolesbb`@`%` FUNCTION  `rolessrv`.`is_user_authorized`(ai_server_user  VARCHAR(20),
...
DROP FUNCTION IF EXISTS `rolessrv`.`is_user_authorized_extended`$$
CREATE DEFINER=`rolesbb`@`%` FUNCTION  `rolessrv`.`is_user_authorized_extended`(ai_server_user VARCHAR(20),
     ai_proxy_user VARCHAR(20),
     ai_kerberos_name VARCHAR(20),
...
DROP FUNCTION IF EXISTS `rolessrv`.`is_user_authorized2`$$
CREATE DEFINER=`rolesbb`@`%` FUNCTION  `rolessrv`.`is_user_authorized2`(ai_server_user VARCHAR(40),
     ai_proxy_user VARCHAR(20),
     ai_kerberos_name VARCHAR(20),
...
DROP FUNCTION IF EXISTS `rolessrv`.`library_user`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`library_user`() RETURNS varchar(50) CHARSET latin1
    READS SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`log_test`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`log_test`(
...
DROP PROCEDURE IF EXISTS `rolessrv`.`my_functions`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`my_functions`(pattern varchar(50))
    READS SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`my_procedures`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`my_procedures`(pattern varchar(50))
    READS SQL DATA
begin
    select routine_schema, routine_name
    from _routine_syntax
...
DROP PROCEDURE IF EXISTS `rolessrv`.`my_routines`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`my_routines`(pattern varchar(50))
    READS SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`parameter_composer`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`parameter_composer`(
...
DROP FUNCTION IF EXISTS `rolessrv`.`procedure_exists`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`procedure_exists`(
    p_db_name varchar(50), 
...
DROP FUNCTION IF EXISTS `rolessrv`.`procedure_exists_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`procedure_exists_simple`(
    p_procedure_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`psyntax`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`psyntax`(
    p_procedure_name varchar(50)
) RETURNS text CHARSET latin1
    READS SQL DATA
begin
...
DROP FUNCTION IF EXISTS `rolessrv`.`routine_exists`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`routine_exists`(
    p_db_name varchar(50), 
    p_routine_name varchar(50),
    p_routine_type enum('procedure','function')
) RETURNS tinyint(1)
...
DROP FUNCTION IF EXISTS `rolessrv`.`routine_exists_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`routine_exists_simple`(
    p_routine_name varchar(50),
    p_routine_type enum('procedure','function')
) RETURNS tinyint(1)
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`routine_syntax`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`routine_syntax`(
    p_db_name       varchar(50),
    p_routine_name  varchar(50),
...
DROP FUNCTION IF EXISTS `rolessrv`.`routine_syntax_text`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`routine_syntax_text`(
    p_routine_id      int
) RETURNS text CHARSET latin1
    READS SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`show_test_results`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`show_test_results`()
    READS SQL DATA
begin
...
DROP PROCEDURE IF EXISTS `rolessrv`.`simple_sp`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`simple_sp`(
...
DROP FUNCTION IF EXISTS `rolessrv`.`simple_sp`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`simple_sp`(
    calling_procedure varchar(50),
    parameters_array  varchar(50)
) RETURNS text CHARSET latin1
    READS SQL DATA
...
DROP PROCEDURE IF EXISTS `rolessrv`.`simple_spl`$$
CREATE DEFINER=`rolesbb`@`localhost` PROCEDURE  `rolessrv`.`simple_spl`(
    calling_procedure varchar(50),
...
DROP FUNCTION IF EXISTS `rolessrv`.`simple_spl`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`simple_spl`(
    calling_procedure varchar(50),
    parameters_list   text
) RETURNS text CHARSET latin1
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`table_exists`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`table_exists`(
    p_db_name varchar(50), 
    p_table_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`table_exists_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`table_exists_simple`(
    p_table_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`table_or_view_exists`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`table_or_view_exists`(
    p_db_name varchar(50), 
    p_table_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`table_or_view_exists_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`table_or_view_exists_simple`(
    p_table_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
return if(isnull(@database), null, coalesce(
...
DROP FUNCTION IF EXISTS `rolessrv`.`view_exists`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`view_exists`(
    p_db_name varchar(50), 
    p_view_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
...
DROP FUNCTION IF EXISTS `rolessrv`.`view_exists_simple`$$
CREATE DEFINER=`rolesbb`@`localhost` FUNCTION  `rolessrv`.`view_exists_simple`(
    p_view_name varchar(50)
) RETURNS tinyint(1)
    READS SQL DATA
return if(isnull(@database), null, coalesce( 
