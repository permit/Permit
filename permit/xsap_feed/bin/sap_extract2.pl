...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +                                                                 +
#  +  See notes on how to modify this script, scattered througout    +
#  +  the script.                                                    +
#  +                                                                 +
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
...
#  Modified 10/13/2006 Added DISPLAY ABSENCE DATA                    
#  Modified 03/01/2007 Added DISPLAY CONFIDENT. EMP DATA             
#  Modified 07/08/2008 Added EHS MAINT, VIEW INSP QUESTIONNAIRE (2 roles)
#  Modified 11/04/2008 Added EHS MAINT SARA CONFIGURATION                
#  Modified 11/18/2008 Added HR  VACA ADMIN FOR EXEMPT STAFF             
#  Modified 04/22/2009 Added HR  APPT: TERM functions                    
#  Modified 06/18/2009 Added HR  APPT: SUPP functions                    
#  Modified 06/18/2009 Added HR  APPT  HRO function                    
#  Modified 07/20/2009 Added HR  APPT  LEAV function                   
#  Modified 10/20/2009 Removed $sel_func_id88 & id94 to prevent 
#                       org unit expansion for those functions
#                       (See comment, search for 88)
#                                  
########################################################################
#
# Get packages
...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If you need to add functions from a new category, add another  +
#  +  $function_categoryN variable below.  You'll use it to call     +
#  +  the get_function_info routine later in the script.             +
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If you need to add functions from a new category, add another  +
#  +  call to the get_function_info routine.  Then, you'll need to   +
#  +  declare the specific functions later in the script.            +
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
...
#
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  To add a new function, follow the pattern below. You'll need   +
#  +  to add lines for the new function in three different places    +
#  +  within the following block of code.  You'll also need to       +
#  +  use the new function_id within a SELECT statement somewhere    +
...
$sel_func_id73 = $fname_to_id{'PROCESS OFF-CYCLE PY SUBSEQUEN'};
$sel_func_id74 = $fname_to_id{'DISPLAY ABSENCE DATA'};
$sel_func_id75 = $fname_to_id{'DISPLAY CONFIDENT. EMP DATA'};
$sel_func_id76 = $fname_to_id{'MAINT FINDING TYPES AND INSPEC'};
$sel_func_id77 = $fname_to_id{'VIEW FINDING TYPES AND INSPEC'};
$sel_func_id78 = $fname_to_id{'MAINT EHS SARA CONFIGURATION'};
$sel_func_id79 = $fname_to_id{'VACA ADMIN FOR EXEMPT STAFF'};
$sel_func_id80 = $fname_to_id{'APPT: INITIATE TERM'};
$sel_func_id81 = $fname_to_id{'APPT: APPROVE TERM'};
$sel_func_id82 = $fname_to_id{'APPT: HRO APPROVE TERM'};
$sel_func_id83 = $fname_to_id{'APPT: PROCESS TERM'};
$sel_func_id84 = $fname_to_id{'APPT: REROUTE TERM WF REQS'};
$sel_func_id85 = $fname_to_id{'APPT: INITIATE SUPP'};
$sel_func_id86 = $fname_to_id{'APPT: APPROVE SUPP'};
$sel_func_id87 = $fname_to_id{'APPT: COMP APPROVE SUPP'};
$sel_func_id88 = $fname_to_id{'APPT: DEAN APPROVE SUPP'};
$sel_func_id89 = $fname_to_id{'APPT: PROCESS SUPP'};
$sel_func_id90 = $fname_to_id{'APPT: REROUTE SUPP WF REQS'};
$sel_func_id91 = $fname_to_id{'HRO'};
$sel_func_id92 = $fname_to_id{'APPT: INITIATE LEAV'};
$sel_func_id93 = $fname_to_id{'APPT: APPROVE LEAV'};
$sel_func_id94 = $fname_to_id{'APPT: DEAN APPROVE LEAV'};
$sel_func_id95 = $fname_to_id{'APPT: PROCESS LEAV'};
$sel_func_id96 = $fname_to_id{'APPT: REROUTE LEAV WF REQS'};
$sel_func_id97 = $fname_to_id{'APPT: INITIATE CHNG'};
$sel_func_id98 = $fname_to_id{'APPT: APPROVE CHNG'};
$sel_func_id99 = $fname_to_id{'APPT: COMP APPROVE CHNG'};
$sel_func_id100 = $fname_to_id{'APPT: DEAN APPROVE CHNG'};
$sel_func_id101 = $fname_to_id{'APPT: PROCESS CHNG'};
$sel_func_id102 = $fname_to_id{'APPT: REROUTE CHNG WF REQS'};
...
if ($sel_func_id1  eq '' || $sel_func_id2  eq '' || $sel_func_id3  eq ''
 ...
 || $sel_func_id73 eq '' || $sel_func_id74 eq '' || $sel_func_id75 eq ''
 || $sel_func_id76 eq '' || $sel_func_id77 eq '' || $sel_func_id78 eq ''
 || $sel_func_id79 eq '' || $sel_func_id80 eq '' || $sel_func_id81 eq ''
 || $sel_func_id82 eq '' || $sel_func_id83 eq '' || $sel_func_id84 eq ''
 || $sel_func_id85 eq '' || $sel_func_id86 eq '' || $sel_func_id87 eq ''
 || $sel_func_id88 eq '' || $sel_func_id89 eq '' || $sel_func_id90 eq ''
 || $sel_func_id91 eq '' || $sel_func_id92 eq '' || $sel_func_id93 eq ''
 || $sel_func_id94 eq '' || $sel_func_id95 eq '' || $sel_func_id96 eq '')

{
  ...
  if ($sel_func_id73 eq '') {
    print "PROCESS OFF-CYCLE PY SUBSEQUEN not found in Function table\n";
  }
  if ($sel_func_id74 eq '') {
    print "DISPLAY ABSENCE DATA not found in Function table\n";
  }
  if ($sel_func_id75 eq '') {
    print "DISPLAY CONFIDENT. EMP DATA not found in Function table\n";
  }
  if ($sel_func_id76 eq '') {
    print "MAINT FINDING TYPES AND INSPEC not found in Function table\n";
  }
  if ($sel_func_id77 eq '') {
    print "VIEW FINDING TYPES AND INSPEC not found in Function table\n";
  }
  if ($sel_func_id78 eq '') {
    print "MAINT EHS SARA CONFIGURATION not found in Function table\n";
  }
   if ($sel_func_id79 eq '') {
    print "VACA ADMIN FOR EXEMPT STAFF not found in Function table\n";
  } 
  if ($sel_func_id80 eq '') {
    print "APPT: INITIATE TERM not found in Function table\n";
  } 
  if ($sel_func_id81 eq '') {
    print "APPT: APPROVE TERM not found in Function table\n";
  } 
  if ($sel_func_id82 eq '') {
    print "APPT: HRO APPROVE TERM not found in Function table\n";
  } 
  if ($sel_func_id83 eq '') {
    print "APPT: PROCESS TERM not found in Function table\n";
  } 
  if ($sel_func_id84 eq '') {
    print "APPT: REROUTE TERM WF REQS not found in Function table\n";
  } 
  if ($sel_func_id85 eq '') {
    print "APPT: INITIATE SUPP not found in Function table\n";
  }
  if ($sel_func_id86 eq '') {
    print "APPT: APPROVE SUPP not found in Function table\n";
  } 
  if ($sel_func_id87 eq '') {
    print "APPT: COMP APPROVE SUPP not found in Function table\n";
  } 
  if ($sel_func_id88 eq '') {
    print "APPT: DEAN APPROVE SUPP not found in Function table\n";
  } 
  if ($sel_func_id89 eq '') {
    print "APPT: PROCESS SUPP not found in Function table\n";
  } 
  if ($sel_func_id90 eq '') {
    print "APPT: REROUTE SUPP WF REQS not found in Function table\n";
  } 
  if ($sel_func_id91 eq '') {
    print "HRO not found in Function table\n";
  } 
  if ($sel_func_id92 eq '') {
    print "APPT: INITIATE LEAV not found in Function table\n";
  }
  if ($sel_func_id93 eq '') {
    print "APPT: APPROVE LEAV not found in Function table\n";
  } 
  if ($sel_func_id94 eq '') {
    print "APPT: DEAN APPROVE LEAV not found in Function table\n";
  } 
  if ($sel_func_id95 eq '') {
    print "APPT: PROCESS LEAV not found in Function table\n";
  } 
  if ($sel_func_id96 eq '') {
    print "APPT: REROUTE LEAV WF REQS not found in Function table\n";
  } 
  if ($sel_func_id97 eq '') {
    print "APPT: INITIATE CHNG not found in Function table\n";
  }
  if ($sel_func_id98 eq '') {
    print "APPT: APPROVE CHNG not found in Function table\n";
  } 
  if ($sel_func_id99 eq '') {
    print "APPT: COMP APPROVE CHNG not found in Function table\n";
  } 
  if ($sel_func_id100 eq '') {
    print "APPT: DEAN APPROVE CHNG not found in Function table\n";
  } 
  if ($sel_func_id101 eq '') {
    print "APPT: PROCESS CHNG not found in Function table\n";
  } 
  if ($sel_func_id102 eq '') {
    print "APPT: REROUTE CHNG WF REQS not found in Function table\n";
...
#  COST, and other qualifiers.  We'll use these to identify people who are 
#  authorized at the root level, which will be handled as a special case.
#  It is particularly important to handle root-level Authorizations for
#  the COST and FUND hierarchies as a special case - expanding out 
#  a root-level authorization to all cost objects or funds will generate
#  hundreds of thousands of records for each person, and it could cause
#  the Roles to SAP feed to fail because of too many SAP profiles for 
#  a person.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  Follow the pattern below if you need to process authorizations
#  +  that use a new qualifier_type.  Add the qualifier type to the
#  +  list within the select statement.  Also, add a new variable
#  +  $top_xxxx_id where xxxx is the new qualifier type.
#  +  You'll use the new variable $top_xxxx_id within select statements
#  +  later in the script to do special processing.  
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
...
#
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If you need to add another EHS function, do it in the following 
#  +  select statement.   The select statement below accommodates
#  +  authorizations with qualifiers in the DEPT hierarchy as well
#  +  as NULL qualifiers.  It could be extended to handle dept-level
#  +  qualifiers from the RSET hierarchy, SAP cannot currently handle
#  +  authorizations at the PI, room-set, or room level via this
#  +  interface.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
 my $stmt = "select distinct
     ...
     where function_id in ($sel_func_id26, $sel_func_id27, $sel_func_id32, $sel_func_id33,
        $sel_func_id76, $sel_func_id77, $sel_func_id78)
     and q.qualifier_id = a.qualifier_id
     and a.parent_qual_id <> $top_dept_id
     and ( (substr(q.qualifier_code, 1, 2) = 'D_')
          or (q.qualifier_code = 'NULL') )
     and a.do_function = 'Y'
     and sysdate between a.effective_date and
                           nvl(a.expiration_date, sysdate)
     and not exists (select q2.qualifier_id
      ...
      and (substr(q2.qualifier_code,1,2) = 'D_' or q2.qualifier_code = 'NULL'))
     order by 3,2,4";
...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If you need to add another function that uses the 8-digit
#  +  org unit hierarchy (ORG2), do it in the following select
#  +  statement.  The select statement currently handles HR and PAYR
#  +  authorizations for the ORG2 hierarchy.  
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
 @stmt = ("select",
           " a.function_id,",
           ...
           " $sel_func_id64, $sel_func_id69, $sel_func_id70, $sel_func_id73,",
           " $sel_func_id75, $sel_func_id79, $sel_func_id80, $sel_func_id81,",
           " $sel_func_id82, $sel_func_id83, $sel_func_id84, $sel_func_id85,",
           " $sel_func_id86, $sel_func_id87, $sel_func_id88, $sel_func_id89,",
           " $sel_func_id90, $sel_func_id91, $sel_func_id92, $sel_func_id93,",
           " $sel_func_id94, $sel_func_id95, $sel_func_id96, $sel_func_id97,",
           " $sel_func_id98, $sel_func_id99, $sel_func_id100, $sel_func_id101,",
           " $sel_func_id102)",
           ...
           " $sel_func_id75, $sel_func_id79, $sel_func_id80, $sel_func_id81,",
           " $sel_func_id82, $sel_func_id83, $sel_func_id84, $sel_func_id85,",
           " $sel_func_id86, $sel_func_id87, $sel_func_id89,",
           " $sel_func_id90, $sel_func_id91, $sel_func_id92, $sel_func_id93,",
           " $sel_func_id95, $sel_func_id96, $sel_func_id97, $sel_func_id98,",
           " $sel_func_id99, $sel_func_id101, $sel_func_id102)",
           " and a.qualifier_id <> $top_org2_id",
           ...
           " order by 3,2,4");
#
# 2009/10/20 George Petrowsky & Jim Repa
# $sel_func_id88 and $sel_func_id94 removed from 'where function_id...' clause
# immediately before this comment to prevent the subordinate Org Units 
# expanded out for those functions. It was leading to conflicting  
# displays of User IDs in the new Appointment Process Redesign functions.
#
...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If you need to add another function that uses the PDED or 
#  +  PMIT qualifier type, modify the following select statement.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
 @stmt0a = ("select",
           " a.function_id,",
...
#
#  Open a cursor, to read PAYR authorizations that use the PYTG (time group)
#  qualifier type.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If you need to add another function that uses the PYTG
#  +  qualifier type (Payroll time group), modify the following select 
#  +  statement.
#  +  See also the next section - you will probably need to modify
#  +  that select statement as well.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
 $stmt1 = "select"
         .  " a.function_id,"
         ...
         .  " $sel_func_id68, $sel_func_id73, $sel_func_id74)"
...
#  +  qualifier type (Payroll time group), modify the following select 
#  +  statement.
#  +  See also the previous section - you will probably need to modify
#  +  that select statement as well.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
...
# 
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If you need to add another function that uses the PCCS
#  +  qualifier type, examine the following select statment.  It might
#  +  automatically handle a new function, snice it finds all
#  +  functions in category PAYR having qualifier type PCCS.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If you need to add another function that uses the BUDG
#  +  qualifier type, modify the following select statment.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
 @stmt = ("select",
...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  The following select statement is used for Labor Distribution
#  +  (LDS) authorizations.  This component is allegedly going away,
#  +  but check with the appropriate people maintaining SAP
#  +  before removing it.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
 @stmt = ("select",
...
#
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  This is a special-purpose SELECT statement for the REPORT BY CO/PC
#  +  function.  It is complicated enough alread, and probably should not 
#  +  be extended to handle additional functions.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
  @stmt = ("select",    # 1
...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  This is a special-purpose SELECT statement for the REPORT BY FUND/FC
#  +  function.  It is complicated enough alread, and probably should not 
#  +  be extended to handle additional functions.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
...
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#  +  If there are any new functions that have special handling for
#  +  root-level authorizations, make a modification here.
#  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
 @stmt = ("select",
           " distinct -function_id, kerberos_name",
