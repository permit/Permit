...
## 9/27/1998 Jim Repa. -Add processing for IAPS qualifiers
## 1/21/1999 Jim Repa. -Add processing for PRIN and LORG qualifiers
## 8/30/2004 Jim Repa. -Add processing for old org units
###############################################################################
...
###############################################################################
{
     ...
     #Being Tested
        ...
        require roles_iaps;      # SAP IAP Session Qualifier Table Feed
        require roles_prin;      # SAP Princ. Inv. Qualifier Table Feed
        require roles_lorg;      # SAP LD Org. Unit Qualifier Table Feed
        require roles_org2;      # Warehouse new Org. Units
        require roles_whcost;    # Warehouse cost_collector table feed
        require roles_oldorg;    # Old 6-digit org units
	require roles_ehst;      # EHS EHST Qualifier Table Feed
	require roles_rset;      # EHS PIs and Room Sets
	require roles_org2;      # 8-digit org units
	require roles_phist;     # person_history
	require roles_pbm1;      # PBM1 hierarchy

        #Additional Modules
#        require roles_aorg;      # Admissions Org Units Qualifier Table Feed
#        require roles_orgu;      # Personnel Org Units Qualifier Table Feed
#        require roles_prof;      # SAP Profit Center Qualifier Table Feed
	...
	print "roles_feed2 - DBParm: '$db_parm' \n";
	...
	print "roles_feed2 - DB: '$db' user: '$id'\n";
	print "roles_feed2 - DBParm: '$db_parm' DB: '$3' user: '$1'\n";
