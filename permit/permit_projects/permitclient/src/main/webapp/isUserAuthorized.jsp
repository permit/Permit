...
<html>
    ...
    <h1>Permitws Web Service isUserAuthorized Test Page</h1>
    ...
    <form action="isUserAuthorizedResponse.jsp" method="POST">
      <table>
        <tr><td>User:</td><td><input type='text' name='username' </td></tr>
        <tr><td>Proxy:</td><td><input type='text' name='proxyname'></td></tr>
        <tr><td>Catagory:</td><td><input type='text' name='catagory'></td></tr>
        <tr><td>Function:</td><td><input type='text' name='function'></td></tr>
        <tr><td>Qualifier:</td><td><input type='text' name='qualifier'></td></tr>
