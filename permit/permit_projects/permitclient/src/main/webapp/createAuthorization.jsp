...
<html>
    <head>
        ...
        <title>Permitws Create Authorization</title>
    </head>
    <body>

    <h1>Permitws Web Service createAuthorization Test Page</h1>
    ...
    <form action="createAuthorizationResponse.jsp" method="POST">
      <table>
