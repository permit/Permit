...
<%
   ...
   permitService_pkg.PermitPickableCategory[] catArray = permitClient.listPickableCategories(request);
   String argString = null;
   
   if (null != catArray) {
       argString = catArray[0].getCategory() + "||" + catArray[0].getDescription();
    for (int i = 1; i < catArray.length; i++) {
       argString += "^^" + catArray[i].getCategory() + "||" + catArray[i].getDescription();
     }
   }
   out.print(argString);
%>